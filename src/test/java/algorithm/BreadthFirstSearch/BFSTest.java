...
class BFSTest extends AlgorithmTest {
    ...
    void calculate5() {
        expectedSequence.addAll(Arrays.asList("A", "B", "E", "D"));
        boolean exp = true;

        BFS algo = new BFS(graphs[4]);
